...
*Defined in [index.ts:4](https://github.com/VitorLuizC/typescript-library-boilerplate/blob/5788377/src/index.ts#L4)*
...
*Defined in [index.ts:23](https://github.com/VitorLuizC/typescript-library-boilerplate/blob/5788377/src/index.ts#L23)*
